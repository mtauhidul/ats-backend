...
const processAttachment = async (attachment, content) => {
  try {
    ...
    try {
      ...
      // Add source information (updated for applications workflow)
      return {
        ...parsedData,
        source: "email_import",
    ...
    // Return basic information (updated for applications workflow)
    return {
...
/**
 * Extract basic application information from email and attachment (updated for applications workflow)
 * @param {string} fromName - Sender's name
 * @param {string} fromEmail - Sender's email
 * @param {string} subject - Email subject
 * @returns {Object} Basic application data
 */
